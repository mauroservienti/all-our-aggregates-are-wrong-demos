...
//         _warehouseApiHost = Warehouse.Api.Program.Build(["--urls", "http://localhost:5033"]);
//
//         await Task.WhenAll(
...
//         _webAppHost = WebApp.Program.Build(
//             ["--urls", "http://localhost:5030"],
//             b => b.Configuration.AddInMemoryCollection(new Dictionary<string, string?>
//             {
